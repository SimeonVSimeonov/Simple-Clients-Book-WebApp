...
@WebServlet("/last")
public class LastNameSortServlet extends HttpServlet {
    private final ModelMapper mapper;
    private final ClientsService clientsService;

    @Inject
    public LastNameSortServlet(ModelMapper mapper, ClientsService clientsService) {
        this.mapper = mapper;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        List<ClientViewModel> clients = clientsService.getAll()
                ...
                .sorted(Comparator.comparing(last -> last.getLastName()))
